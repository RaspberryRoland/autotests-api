from concurrent import \
    futures  # Импорт пула потоков для асинхронного выполнения

import grpc  # Импорт библиотеки gRPC

import \
    course_service_pb2  # Сгенерированные классы для работы с gRPC-сообщениями
...
class CourseServiceServicer(course_service_pb2_grpc.CourseServiceServicer):
    ...
    def GetCourse(self, request, context):
        ...
        print(
            f'Получен запрос к методу GetCourse для курса с id: {request.course_id}')
